...
import { MatSidenav, MatDialog, MatSnackBar, MatSnackBarHorizontalPosition, MatSnackBarVerticalPosition } from '@angular/material';
...
@Component({
  selector: 'app-inbox-brand',
  templateUrl: './inbox-brand.component.html',
  styleUrls: ['./inbox-brand.component.scss']
})
export class InboxBrandComponent implements OnInit {
  isMobile;
